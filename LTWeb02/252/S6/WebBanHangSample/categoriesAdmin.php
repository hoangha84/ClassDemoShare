...
<body>
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p class="lead text-muted">Quản lý danh mục sản phẩm</p>
            </div>
        </section>
        ...
        <div class="container">
            ...
            $rs = getItemsPaging($sql, $conn, "categoriesAdmin.php?", $_GET["pageNumber"] ?? "1", PAPP);
                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        for ($i = 0; $i < count($rs) - 1; $i++) {
                            ...
                            ?>
                            <td>
                                <a href="categoriesEdit.php?MADM=<?php echo $rs[$i]["MADM"] ?>&ACT=VIEW" <i
                                ...
                                <!-- <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?MASP=" . $rs[$i]["MASP"] ?>&ACT=DELETE"
                                    ...
                                    Delete</i></a> -->
                                <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?MADM=" . $rs[$i]["MADM"] ?>&ACT=DELETE"
                                    <i class="fa fa-close text-left"
                                    onClick="return deleteDM('<?php echo $rs[$i]["MADM"] ?>');">
                                    Delete</i></a>
                            </td>
                            </tr>
                            <?php
    ...
    <script>
        function deleteDM(madm) {
            if (confirm('Bạn có chắc muốn xóa SP ' + madm + ' ?')) {
                ...
                xmlhttp.open("GET", "categoriesDelete.php?madm=" + madm, true);
                xmlhttp.send();
            }
            else {
                return false;
